...
//! ModelViewMatrix, die nur während des Durchlaufens des Baumes berechnet werden kann, für das sortierte Rendern
...
public:
    ...
    const QMatrix4x4& getModelViewMatrix() const {return mModelViewMatrix;}
...
private:
    //! Die über updateModelViewMatrix() gesetzte ModelViewMatrix.
...
//inline const QMatrix4x4& Shape::getModelViewMatrix() const
//{
//    return mModelViewMatrix;
//}

//inline Shape& Shape::getNextShape() const
//{
//    return *mNextShape;
//}

//inline Drawable& Shape::getDrawable()
//{
//    return mDrawable;
//}

//inline const QMap<ShapeList*, bool>& Shape::getIsInShapeList() const
//{
//    return mIsInShapeList;
//}

//inline void Shape::setNextShape(Shape* nextShape)
//{
