...
public:
    ...
    //! Bindet die pro Shape unterschiedlchen Uniforms wie Projektions- und ModelViewMatrix.
    static void bindShapeUniforms(const QMatrix4x4& modelViewMatrix, Shader& shader);
