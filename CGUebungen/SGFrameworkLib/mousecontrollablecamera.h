#ifndef MOUSECONTROLLABLECAMERA_H
#define MOUSECONTROLLABLECAMERA_H
...
class MouseControllableCamera : public ControllableCamera
{
public:
    MouseControllableCamera();
...
#endif // MOUSECONTROLLABLECAMERA_H
