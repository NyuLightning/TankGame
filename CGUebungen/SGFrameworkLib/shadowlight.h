...
public:
    ...
    void resetCCS() {mCamera->resetCCS();}
    void setPosition(QVector3D pPosition) {mCamera->setPosition(pPosition);}
    void rotate(float pX, float pY, float pZ) {mCamera->rotate(pX,pY,pZ);}
